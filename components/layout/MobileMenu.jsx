          ...
          <div className="container mx-auto px-4 sm:px-6 py-4 sm:py-6">
            ...
            >
              ...
              <div className="flex items-center space-x-4">
                <button className="focus:outline-none hidden sm:block" aria-label="User Profile">
                  <svg 
            ...
            >
              <div className="flex items-center justify-center sm:justify-start space-x-6 mb-6 sm:mb-0">
                <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-brand-olive-400 transition-colors">
                ...
                <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-brand-olive-400 transition-colors">
                ...
                <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-brand-olive-400 transition-colors">
              ...
              <div className="flex justify-center sm:justify-end">
                <div className="inline-flex rounded-md shadow-sm">
                  <button type="button" className="py-2 px-3 text-sm font-medium text-gray-900 bg-white rounded-l-md border border-gray-200 hover:bg-gray-100 focus:outline-none">
                    EN
                  </button>
                  <button type="button" className="py-2 px-3 text-sm font-medium text-gray-400 bg-white border-t border-b border-r border-gray-200 hover:bg-gray-100 focus:outline-none">
                    DE
                  </button>
                </div>
              </div>
