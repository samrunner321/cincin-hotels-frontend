...
export default function ContentTabs() {
  ...
  const tabsPositionRef = useRef(null); // Store the original position
  ...
  const tabs = [
    ...
    { id: 'restaurants', label: 'Food & Drinks' },
    { id: 'hotel-destination', label: 'Discover' }
  ];
  ...
  useEffect(() => {
    ...
    const measureNavbar = () => {
      ...
      // Also store the content tabs height to ensure consistency
